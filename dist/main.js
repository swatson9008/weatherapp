...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../src/asset/Unbounded-VariableFont_wght.ttf */ "./src/asset/Unbounded-VariableFont_wght.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../src/asset/RussoOne-Regular.ttf */ "./src/asset/RussoOne-Regular.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ../src/asset/blue-cloudy-sky-landscape-background-free-vector.png */ "./src/asset/blue-cloudy-sky-landscape-background-free-vector.png"), __webpack_require__.b);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@font-face {\n    font-family: 'weather-style';\n    src: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n}\n\n@font-face {\n    font-family: 'search-style';\n    src: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\n}\n\nbody {\n    background-color: darkgray;\n    background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ");\n}\n\ninput {\n    all: unset;\n    cursor: pointer;\n}\n\nbutton {\n    all: unset;\n    cursor: pointer;\n}\n\nh1 {\n    text-align: center;\n    font-family: 'search-style';\n}\n\n#mainContainer {\n    display: flex;  \n    justify-content: center;  \n    align-items: center;  \n    flex-direction: column;\n    margin-top: 100px;\n}\n\n#searchField {\n    background-color: rgba(151, 204, 231, 0.747);\n    border: rgba(164, 217, 243, 0.747) solid 3px;\n    border-radius: 4px;\n    padding: 5px;\n    margin-right: 10px;\n    font-family: 'search-style';\n}\n\n#searchB {\n    background-color: rgb(107, 156, 204);\n    padding: 5px;\n    border-radius: 4px;\n    font-family: 'search-style';\n}\n\n#weatherDiv {\n    display:grid;\n    margin-top: 50px;\n    justify-content: space-around;\n    gap: 10px;\n    grid-template-columns: 1fr 1fr;\n    background-color: rgb(53, 53, 53);\n    color:aliceblue;\n    padding: 15px;\n    border-radius: 5px;\n    font-family: 'weather-style';\n    \n    \n}\n\n#nameID {\n    grid-row: 1;\n    font-weight: bold;\n    font-family: 'weather-style';\n}\n\n#iconID {\n    grid-row: 2 / 5;\n}\n\n#feelID {\n    font-style: italic;\n    font-size: 12px;\n    opacity: 0.7;\n}\n\n#FnC {\n    border-style: solid;\n    border-color: rgb(148, 147, 147);\n    padding: 5px;\n    border-radius: 8px;\n}\n\n\n#footer {\n    display: flex;\n    align-content: center;\n    justify-content: center;\n    gap: 0.5em;\n    padding: 0.5em;\n    background-color: aliceblue;\n    grid-row: 4;\n    grid-column: 4;\n    /*border: 1px red solid;*/\n    position: fixed;\n    width: 100%;\n    bottom:0;\n    left:0;\n    right:0;\n    margin-top: 120px  \n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,4BAA4B;IAC5B,4CAAsD;AAC1D;;AAEA;IACI,2BAA2B;IAC3B,4CAA2C;AAC/C;;AAEA;IACI,0BAA0B;IAC1B,yDAA0F;AAC9F;;AAEA;IACI,UAAU;IACV,eAAe;AACnB;;AAEA;IACI,UAAU;IACV,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,2BAA2B;AAC/B;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,sBAAsB;IACtB,iBAAiB;AACrB;;AAEA;IACI,4CAA4C;IAC5C,4CAA4C;IAC5C,kBAAkB;IAClB,YAAY;IACZ,kBAAkB;IAClB,2BAA2B;AAC/B;;AAEA;IACI,oCAAoC;IACpC,YAAY;IACZ,kBAAkB;IAClB,2BAA2B;AAC/B;;AAEA;IACI,YAAY;IACZ,gBAAgB;IAChB,6BAA6B;IAC7B,SAAS;IACT,8BAA8B;IAC9B,iCAAiC;IACjC,eAAe;IACf,aAAa;IACb,kBAAkB;IAClB,4BAA4B;;;AAGhC;;AAEA;IACI,WAAW;IACX,iBAAiB;IACjB,4BAA4B;AAChC;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,eAAe;IACf,YAAY;AAChB;;AAEA;IACI,mBAAmB;IACnB,gCAAgC;IAChC,YAAY;IACZ,kBAAkB;AACtB;;;AAGA;IACI,aAAa;IACb,qBAAqB;IACrB,uBAAuB;IACvB,UAAU;IACV,cAAc;IACd,2BAA2B;IAC3B,WAAW;IACX,cAAc;IACd,yBAAyB;IACzB,eAAe;IACf,WAAW;IACX,QAAQ;IACR,MAAM;IACN,OAAO;IACP;AACJ","sourcesContent":["@font-face {\n    font-family: 'weather-style';\n    src: url(../src/asset/Unbounded-VariableFont_wght.ttf);\n}\n\n@font-face {\n    font-family: 'search-style';\n    src: url(../src/asset/RussoOne-Regular.ttf);\n}\n\nbody {\n    background-color: darkgray;\n    background-image: url('../src/asset/blue-cloudy-sky-landscape-background-free-vector.png');\n}\n\ninput {\n    all: unset;\n    cursor: pointer;\n}\n\nbutton {\n    all: unset;\n    cursor: pointer;\n}\n\nh1 {\n    text-align: center;\n    font-family: 'search-style';\n}\n\n#mainContainer {\n    display: flex;  \n    justify-content: center;  \n    align-items: center;  \n    flex-direction: column;\n    margin-top: 100px;\n}\n\n#searchField {\n    background-color: rgba(151, 204, 231, 0.747);\n    border: rgba(164, 217, 243, 0.747) solid 3px;\n    border-radius: 4px;\n    padding: 5px;\n    margin-right: 10px;\n    font-family: 'search-style';\n}\n\n#searchB {\n    background-color: rgb(107, 156, 204);\n    padding: 5px;\n    border-radius: 4px;\n    font-family: 'search-style';\n}\n\n#weatherDiv {\n    display:grid;\n    margin-top: 50px;\n    justify-content: space-around;\n    gap: 10px;\n    grid-template-columns: 1fr 1fr;\n    background-color: rgb(53, 53, 53);\n    color:aliceblue;\n    padding: 15px;\n    border-radius: 5px;\n    font-family: 'weather-style';\n    \n    \n}\n\n#nameID {\n    grid-row: 1;\n    font-weight: bold;\n    font-family: 'weather-style';\n}\n\n#iconID {\n    grid-row: 2 / 5;\n}\n\n#feelID {\n    font-style: italic;\n    font-size: 12px;\n    opacity: 0.7;\n}\n\n#FnC {\n    border-style: solid;\n    border-color: rgb(148, 147, 147);\n    padding: 5px;\n    border-radius: 8px;\n}\n\n\n#footer {\n    display: flex;\n    align-content: center;\n    justify-content: center;\n    gap: 0.5em;\n    padding: 0.5em;\n    background-color: aliceblue;\n    grid-row: 4;\n    grid-column: 4;\n    /*border: 1px red solid;*/\n    position: fixed;\n    width: 100%;\n    bottom:0;\n    left:0;\n    right:0;\n    margin-top: 120px  \n}"],"sourceRoot":""}]);
// Exports
...
/***/ "./src/asset/RussoOne-Regular.ttf":
/*!****************************************!*\
  !*** ./src/asset/RussoOne-Regular.ttf ***!
  \****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./src/asset/Unbounded-VariableFont_wght.ttf":
/*!***************************************************!*\
  !*** ./src/asset/Unbounded-VariableFont_wght.ttf ***!
  \***************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
async function defaultApi() {
  try {
    const response = await fetch('https://api.openweathermap.org/data/2.5/weather?q=Tokyo&APPID=ddc8fb6879ccbfc5d2782d6a632b1b65&units=imperial', {
      mode: 'cors'
    });
...
async function getWeather() {
  try {
    const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${searchField.value}&APPID=ddc8fb6879ccbfc5d2782d6a632b1b65&units=imperial`, {
      mode: 'cors'
    });
    const weatherData = await response.json();
    let newWeather = {
